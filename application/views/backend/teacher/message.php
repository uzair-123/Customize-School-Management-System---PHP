<div class="pull-right" style="text-align: right; margin-top: -30px;">
  <a href="<?php echo base_url().'index.php?teacher/group_message'; ?>" class="btn btn-blue"><i class="fa fa-comments" aria-hidden="true"></i> <?php echo get_phrase('group_message'); ?></a>
</div>
<hr />
<div class="mail-env">
    ...
    <div class="mail-sidebar" style="min-height: 800px;">
        ...
        <div class="mail-sidebar-row hidden-xs">
            <a href="<?php echo base_url(); ?>index.php?teacher/message/message_new" class="btn btn-success btn-block">
