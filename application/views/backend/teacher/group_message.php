...
<div class="pull-right" style="text-align: right; margin-top: -30px;">
  <a href="<?php echo base_url().'index.php?teacher/message'; ?>" class="btn btn-blue"><i class="fa fa-comment" aria-hidden="true"></i> <?php echo get_phrase('private_message'); ?></a>
</div>
<hr />
<div class="mail-env">
            ...
            <?php
              ...
              foreach ($group_messages as $row):
                ...
                <div class="col-sm-10" style="text-align:left; margin: 0; padding: 0;">
                  <a href="<?php echo base_url(); ?>index.php?teacher/group_message/group_message_read/<?php echo $row['group_message_thread_code']; ?>" style="padding:12px;">
                      <i class="entypo-dot"></i>
                      <?php echo $row['group_name'] ?>
                  </a>
                </div>
                <div class="col-sm-2" style="text-align:right; margin: 0 0; padding: 12px 5px;">
                  <a href="#" class="customize_group" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/group_info/<?php echo $row['group_message_thread_code']; ?>');" style="margin: 0; padding: 0;"><i class="fa fa-cog" aria-hidden="true"></i></a>
                </div>
              </li>
              <?php endif; ?>
            <?php endforeach;
