...
<div class="pull-right" style="text-align: right; margin-top: -30px;">
  <a href="<?php echo base_url().'index.php?parents/message'; ?>" class="btn btn-blue"><i class="fa fa-comment" aria-hidden="true"></i> <?php echo get_phrase('private_message'); ?></a>
</div>
<hr />
<div class="mail-env">
            ...
            <?php
              ...
              foreach ($group_messages as $row):
                ...
                <div class="col-sm-10" style="text-align:left; margin: 0; padding: 0;">
                  <a href="<?php echo base_url(); ?>index.php?parents/group_message/group_message_read/<?php echo $row['group_message_thread_code']; ?>" style="padding:12px;">
