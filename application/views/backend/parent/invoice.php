            ...
            <div class="tab-pane box active" id="list">
                ...
                <div class="row">
                  <div class="col-md-4" style="text-align: center;">
                    <?php echo form_open(base_url() . 'index.php?parents/paypal_checkout/' . $row['student_id']);?>
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <?php echo form_open(base_url() . 'index.php?parents/stripe_checkout/' . $row['student_id']);?>
                    	<input type="hidden" name="invoice_id" value="<?php echo $row2['invoice_id'];?>" />
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <a href="<?php echo base_url('index.php?parents/pay_with_payumoney/'.$row['student_id'].'/'.$row2['invoice_id']);?>" type="button" class="btn btn-success" <?php if($row2['due'] == 0):?> disabled="disabled"<?php endif;?>> <span data-toggle="tooltip" title="PayUMoney"> <i class="fa fa-dollar" aria-hidden="true" style="color: #fff;"></i> PayUMoney</span> </a>
                  </div>
                </div>
              </td>
                        </tr>
