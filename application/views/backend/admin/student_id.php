...
<div class="id-card-holder">
    <div class="id-card">
        <div class="header" style="text-align: left;margin-left: 0px">
            <img src="uploads/logo.png"  style="max-height:60px;max-width: 60px"/>
        ...
        <hr>
            <img style="-webkit-user-select: none;max-width:200px;background-position: 0px 0px, 10px 10px;background-size: 20px 20px;background-image:linear-gradient(45deg, #eee 25%, transparent 25%, transparent 75%, #eee 75%, #eee 100%),linear-gradient(45deg, #eee 25%, white 25%, white 75%, #eee 75%, #eee 100%);" src="<?php echo base_url();?>index.php?admin/create_barcode/<?php echo $student->student_code;?>">
...
<a  target="_blank" href="<?php echo base_url();?>index.php?admin/print_id/<?php echo $student->student_id; ?>" class="btn btn-primary"><i class="entypo-print"></i> Print</a>
