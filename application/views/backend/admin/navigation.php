...
$query = $this->db->query("select * from guardian where '$x' between s_date and e_date");
     ...
     <li class="<?php if ($page_name == 'sms') echo 'active'; ?> ">
      ...
      <!-- TEACHER RIGHTS  -->
        <li class="<?php if ($page_name == 'permission') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/permission">
                <i class="entypo-book"></i>
                <span><?php echo get_phrase('teacher permission'); ?></span>
            </a>
        </li>
...
else
{
 ...
 <li class="<?php if ($page_name == 'license') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/license">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('YOUR SOFTWARE LICENSE EXPIRED !!!  ,Activate Software'); ?></span>
                    </a>
                </li>
