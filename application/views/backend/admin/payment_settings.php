...
<!--                            <li><a href="#tab4" data-toggle="tab">PayTM</a></li>-->
                        ...
                        <div class="tab-content">
                            ...
                            ?>
                                <form action="<?php echo base_url().'index.php?admin/payment_settings/update_paypal_keys';?>"
                            ...
                            ?>
                            <form action="<?php echo base_url().'index.php?admin/payment_settings/update_stripe_keys';?>"
                                class="form-horizontal form-groups" method="post">
                           ...
                           <div class="tab-pane" id="tab3">
                             <form action="<?php echo base_url().'index.php?admin/payment_settings/update_payumoney_keys';?>"
                                 class="form-horizontal form-groups" method="post">
                               <div class="form-group">
