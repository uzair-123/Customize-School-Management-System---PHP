				...
				<div class="tab-pane <?php if($active_tab == 'invoices') echo 'active'; ?>" id="unpaid">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($row['amount'] - $row['amount_paid'] == 0):?>
                            	<td>
                            		<button class="btn btn-success btn-xs"><?php echo get_phrase('paid');?></button>
                            	</td>
                            <?php endif;?>
                            	<td>
                            <?php if($row['amount'] - $row['amount_paid'] > 0 && $row['status'] != 'paid' ) :?>
                            		<button class="btn btn-danger btn-xs"><?php echo get_phrase($row['status']);?></button>
                            	</td>  	
                            <?php endif;?>
