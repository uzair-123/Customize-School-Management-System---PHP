...
<?php 
    $c = $this->db->get_where('settings', array('type' => 'system_name' ))->result_array();
...
<div class="privacy-area page-content-area">
        ...
        <div class="row">
            <div class="col">
                <div class="page-title">
                  <h1 style="margin-left: 450px"><?php echo get_phrase($r['description'])  ?> </h1>
    ...
    $classes = $this->db->get_where('settings', array('type' => 'system_email' ))->result_array();
   ...
   foreach ($classes as $row) {
    ...
    # code...
        ...
        $classess = $this->db->get_where('settings', array('type' => 'phone' ))->result_array();


   foreach ($classess as $rowy) {

    # code...
   }
       
        $classesss = $this->db->get_where('settings', array('type' => 'address' ))->result_array();


   foreach ($classesss as $rowyy) {
                        ...
                        <div class="widgets-content">
                          <ul>
                            <li>
                              ...
                              <p><strong> <?php echo get_phrase('address'); ?>: </strong><?php echo $rowyy['description'] ?></p>
                            </li>
                            <li>
                              <p><strong><?php echo get_phrase('email'); ?>: </strong><?php echo $row['description'] ?></p>
                            </li>
                            <li>
                              <p><strong><?php echo get_phrase('phone'); ?>: </strong><?php echo $rowy['description'] ?></p>
                            </li>
